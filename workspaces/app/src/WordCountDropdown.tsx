...
export default function WordCountDropdown({ wordCount, charCount, readMin, theme, uiFont }: WordCountDropdownProps) {
  ...
  return (
    <div className="absolute top-6 right-16 z-50 flex items-center" ref={containerRef}>
      <button 
      ...
      {open && (
        <div 
          className="absolute right-0 mt-2 p-3 rounded-2xl shadow-2xl w-60 border"
          style={{
            top: '100%',
        ...
        >
          <div className="flex justify-between items-center py-2.5 border-b" style={{ borderColor: theme.borderFaint }}>
            <span style={{ fontSize: '0.9rem' }}>Words</span>
          ...
          <div className="flex justify-between items-center py-2.5">
            <span style={{ fontSize: '0.9rem' }}>Reading time</span>
